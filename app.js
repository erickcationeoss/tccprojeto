...
window.onload = function() {
    ...
    setTimeout(() => {
        ...
        // Adicionamos logs para verificar se as telas estão sendo encontradas
        console.log('authScreen encontrado:', authScreen ? true : false);
        console.log('chatScreen encontrado:', chatScreen ? true : false);
        ...
        async function handleSendMessage() {
            ...
            try {
                // ✅ Agora usamos window.askGemini em vez de window.askEdenAI
                const response = await window.askGemini(question);
                if (response.success) {
